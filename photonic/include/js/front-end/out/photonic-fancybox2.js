...
/***/ "../include/js/front-end/src/Lightboxes/Fancybox2.js":
/*!***********************************************************!*\
  !*** ../include/js/front-end/src/Lightboxes/Fancybox2.js ***!
  \***********************************************************/
/*! flagged exports */
/*! export PhotonicFancybox2 [provided] [no usage info] [missing usage info prevents renaming] */
/*! export __esModule [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
/*! runtime requirements: __webpack_exports__, __webpack_require__ */
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
class PhotonicFancybox2 extends _Lightbox.Lightbox {
  ...
  initialize(selector, group) {
    ...
    $('a.photonic-fancybox').fancybox({
      ...
      autoResize: true,
      scrolling: 'no',
      afterShow: function afterShow(current, previous) {
        self.swipe();
        var shareable = {
          'url': location.href,
        ...
        if (videoURL !== undefined) {
          self.getVideoSize(videoURL, {
            height: window.innerHeight * 0.85 - 30 - 40,
            width: window.innerWidth * 0.85 - 30
            ...
            $('.fancybox-skin .fancybox-inner').css({
              overflow: 'hidden'
            });
          });
        }
    ...
    $('a.fancybox2-html5-video').each(function () {
      ...
      $(this).fancybox({
        ...
        beforeLoad: function beforeLoad() {
          self.getVideoSize(videoURL, {
            height: window.innerHeight - 30 - 40,
...
exports.PhotonicFancybox2 = PhotonicFancybox2;
...
(() => {
/*!********************************************************!*\
  !*** ../include/js/front-end/src/Entries/Fancybox2.js ***!
  \********************************************************/
/*! unknown exports (runtime-defined) */
...
var _Fancybox = __webpack_require__(/*! ../Lightboxes/Fancybox2 */ "../include/js/front-end/src/Lightboxes/Fancybox2.js");
...
jQuery(document).ready(function ($) {
  var lightbox = new _Fancybox.PhotonicFancybox2($);
