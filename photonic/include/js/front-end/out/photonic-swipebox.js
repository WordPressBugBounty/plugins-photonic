...
/***/ "../include/js/front-end/src/Lightboxes/Swipebox.js":
/*!**********************************************************!*\
  !*** ../include/js/front-end/src/Lightboxes/Swipebox.js ***!
  \**********************************************************/
/*! flagged exports */
/*! export PhotonicSwipebox [provided] [no usage info] [missing usage info prevents renaming] */
/*! export __esModule [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
/*! runtime requirements: __webpack_exports__, __webpack_require__ */
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports.PhotonicSwipebox = void 0;
...
class PhotonicSwipebox extends _Lightbox.Lightbox {
  constructor($) {
    super();
    this.$ = $;
  }
    ...
    if (thumb != null) {
      ...
      if (videoURL !== undefined) {
        this.getVideoSize(videoURL, {
          ...
          $('.swipebox-inline-container ' + videoID).find('video').attr({
  ...
  initialize(selector, group) {
    ...
    $('a.photonic-swipebox, a.swipebox-video, a.swipebox-html5-video').swipebox({
      ...
      beforeOpen: function beforeOpen(e) {
        ...
        if (evt !== undefined) {
          var clicked = $(evt.target).parents('.photonic-swipebox');

          if (clicked.length > 0) {
            this.currentThumb = clicked[0];
          } else {
            var all_matches = $('[data-photonic-deep="' + _Core.Core.getDeep().substr(1) + '"]');
      ...
      afterOpen: function afterOpen(idx) {
        if (this.videoURL) {
      ...
      prevSlide: function prevSlide(idx) {
        self.changeSlide(this.currentThumb, idx);
      },
      nextSlide: function nextSlide(idx) {
        self.changeSlide(this.currentThumb, idx);
      },
...
exports.PhotonicSwipebox = PhotonicSwipebox;
...
(() => {
/*!*******************************************************!*\
  !*** ../include/js/front-end/src/Entries/Swipebox.js ***!
  \*******************************************************/
/*! unknown exports (runtime-defined) */
...
var _Swipebox = __webpack_require__(/*! ../Lightboxes/Swipebox */ "../include/js/front-end/src/Lightboxes/Swipebox.js");
...
jQuery(document).ready(function ($) {
  var lightbox = new _Swipebox.PhotonicSwipebox($);
