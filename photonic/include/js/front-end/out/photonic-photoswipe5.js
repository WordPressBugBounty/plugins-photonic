...
/***/ "../include/js/front-end/src/Lightboxes/PhotoSwipe5.js":
/*!*************************************************************!*\
  !*** ../include/js/front-end/src/Lightboxes/PhotoSwipe5.js ***!
  \*************************************************************/
/*! flagged exports */
/*! export PhotonicPhotoSwipe5 [provided] [no usage info] [missing usage info prevents renaming] */
/*! export __esModule [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
/*! runtime requirements: __webpack_exports__, __webpack_require__ */
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports.PhotonicPhotoSwipe5 = void 0;
...
class PhotonicPhotoSwipe5 extends _Lightbox.Lightbox {
  constructor() {
    super();
  }
      ...
      lightbox.pswp.ui.registerElement({
        ...
        onInit: (el, pswp) => {
          lightbox.pswp.on('change', () => {
            ...
            if (currSlideElement) {
              var hiddenCaption = Util.HTMLSanitizer.SanitizeHTML(currSlideElement.getAttribute('data-title'));
        ...
        onInit: (el, pswp) => {
          lightbox.pswp.on('change', () => {
            if (Photonic_JS.social_media) {
              ...
              if (currSlideElement) {
                var title = Util.getText(currSlideElement.getAttribute('data-title'));
                var image = currSlideElement.href;
                var social = self.socialIcons.replace(/{photonic_share_link}/g, encodeURIComponent(url)).replace(/{photonic_share_title}/g, encodeURIComponent(title)).replace(/{photonic_share_image}/g, encodeURIComponent(image));
  ...
  initialize(selector) {
    ...
    document.querySelectorAll('.photonic-photoswipe-solo').forEach((current, idx) => {
      ...
      lightbox.on('beforeOpen', e => {
        ...
        function waitForDim() {
          return _waitForDim.apply(this, arguments);
        }

        function _waitForDim() {
          _waitForDim = (0, _asyncToGenerator2.default)(function* () {
            yield soloImageDim();
          });
          return _waitForDim.apply(this, arguments);
        }
    ...
    document.querySelectorAll('.photoswipe-video, .photoswipe-html5-video').forEach((current, idx) => {
      var href = current.href;
      var anchorId = current.getAttribute('id');
      var lightbox = new PhotoSwipeLightbox({
        gallery: '#' + anchorId,
        pswpModule: PhotoSwipe
      });
...
exports.PhotonicPhotoSwipe5 = PhotonicPhotoSwipe5;
...
(() => {
/*!**********************************************************!*\
  !*** ../include/js/front-end/src/Entries/PhotoSwipe5.js ***!
  \**********************************************************/
/*! unknown exports (runtime-defined) */
...
var _PhotoSwipe = __webpack_require__(/*! ../Lightboxes/PhotoSwipe5 */ "../include/js/front-end/src/Lightboxes/PhotoSwipe5.js");
...
document.addEventListener('DOMContentLoaded', () => {
  var lightbox = new _PhotoSwipe.PhotonicPhotoSwipe5();
