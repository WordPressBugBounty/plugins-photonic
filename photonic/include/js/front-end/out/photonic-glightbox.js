    ...
    selection.forEach(gallery => {
      ...
      if (galleryItems.length > 0) {
        ...
        if (rel != null) {
          ...
          lightbox.on('slide_changed', (_ref) => {
            var {
              prev,
              current
            } = _ref;
      ...
      } else if (!gallery.classList.contains('photonic-level-2-container') && !gallery.querySelector('.photonic-level-2-container') && !gallery.querySelector('.photonic-tree')) {
