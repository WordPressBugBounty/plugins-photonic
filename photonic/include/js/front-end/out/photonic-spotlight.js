...
/***/ "../include/js/front-end/src/Lightboxes/Spotlight.js":
/*!***********************************************************!*\
  !*** ../include/js/front-end/src/Lightboxes/Spotlight.js ***!
  \***********************************************************/
/*! flagged exports */
/*! export PhotonicSpotlight [provided] [no usage info] [missing usage info prevents renaming] */
/*! export __esModule [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
/*! runtime requirements: __webpack_exports__, __webpack_require__ */
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports.PhotonicSpotlight = void 0;
...
class PhotonicSpotlight extends _Lightbox.Lightbox {
  constructor() {
    super();
  }
  ...
  initialize(selector) {
    ...
    selection.forEach(current => {
      var links = current.querySelectorAll('.photonic-lb');

      if (links.length > 0) {
        var rel = links.item(0).getAttribute('rel'); // Get "rel" from first "a" element
        ...
        _Core.Core.addToLightboxList(rel, gallery);
      }
    });
    document.addEventListener('click', e => {
      ...
      e.preventDefault();
      var clicked = e.target.closest('.photonic-lb');
      var container = clicked.closest('.photonic-level-1-container');
      var siblings = container.querySelectorAll('.photonic-lb');
      var index = Array.from(siblings).indexOf(clicked);
      var rel = clicked.getAttribute('rel');

      var gallery = _Core.Core.getLightboxList()[rel];
    ...
    document.addEventListener('click', e => {
      ...
      e.preventDefault();
      var clicked = e.target.closest('.spotlight-embed-video');
      spotlight.show([{
        media: "node",
        src: function () {
    ...
    document.addEventListener('click', e => {
      ...
      e.preventDefault();
      var clicked = e.target.closest('.spotlight-video');
      spotlight.show([{
        media: "video",
...
exports.PhotonicSpotlight = PhotonicSpotlight;
...
(() => {
/*!********************************************************!*\
  !*** ../include/js/front-end/src/Entries/Spotlight.js ***!
  \********************************************************/
/*! unknown exports (runtime-defined) */
...
var _Spotlight = __webpack_require__(/*! ../Lightboxes/Spotlight */ "../include/js/front-end/src/Lightboxes/Spotlight.js");
...
document.addEventListener('DOMContentLoaded', () => {
  var lightbox = new _Spotlight.PhotonicSpotlight();
