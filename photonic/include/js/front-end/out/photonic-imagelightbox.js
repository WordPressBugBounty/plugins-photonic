...
/***/ "../include/js/front-end/src/Lightboxes/ImageLightbox.js":
/*!***************************************************************!*\
  !*** ../include/js/front-end/src/Lightboxes/ImageLightbox.js ***!
  \***************************************************************/
/*! flagged exports */
/*! export PhotonicImageLightbox [provided] [no usage info] [missing usage info prevents renaming] */
/*! export __esModule [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
/*! runtime requirements: __webpack_exports__, __webpack_require__ */
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
exports.PhotonicImageLightbox = void 0;
...
class PhotonicImageLightbox extends _Lightbox.Lightbox {
  constructor($) {
    super();
    this.$ = $;
  }
  ...
  initialize(selector, group) {
    ...
    $(selector).each(function (i, current) {
      ...
      var rel = $(current).find('a.photonic-imagelightbox');
      ...
      var photonicImageLightbox = $(lightbox_selector).imageLightbox(lightbox_selector, {
      ...
      _Core.Core.addToLightboxList(lightbox_selector, photonicImageLightbox);
    });
  }
...
exports.PhotonicImageLightbox = PhotonicImageLightbox;
...
(() => {
/*!************************************************************!*\
  !*** ../include/js/front-end/src/Entries/ImageLightbox.js ***!
  \************************************************************/
/*! unknown exports (runtime-defined) */
...
var _ImageLightbox = __webpack_require__(/*! ../Lightboxes/ImageLightbox */ "../include/js/front-end/src/Lightboxes/ImageLightbox.js");
...
jQuery(document).ready(function ($) {
  var lightbox = new _ImageLightbox.PhotonicImageLightbox($);
